...
def DnsSearch(orglist):
    ...
    print("""
The following url's have returned positive IP addresses. Referencing the line number, enter the line which represents
...
def CleanContacts(contactemails):
    ...
    print("""
The following unique domain names have been found:""")
    for i in list:
        print(i)
...
def mxlookup(list):
    print(""".
.
Commencing MX Lookup on identified domains
""")
    mxlist = {}
    for i in list:
